...
module.exports = function generate(ctx) {
  ...
  **/
        ...
        */
        {
          ...
          params: {
            ...
            paramIsPostData: paramIsPostData,
  ...
  function buildMethodParams(model, methodName, params, isIo) {
    ...
    params = params.filter(param => !paramIsFunction(param));
  ...
  /**
   * @method paramIsPostData
   * @description
   * Testing if the param is post data type
   */
  function paramIsPostData(param) {
  ...
  function buildPostBody(postData) {
    ...
    if (Array.isArray(postData)) {
      postData = postData.filter(paramIsPostData)
